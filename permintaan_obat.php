...
<link rel="icon" type="image" href="dist/img/logokejati.png">
  <title>Aplikasi Pengelolaan</title>
...
if ($_SESSION['admin']){
  ...
  <aside class="main-sidebar sidebar-dark-primary elevation-4">
    ...
    <a href="index3.php" class="brand-link">
      <img src="dist/img/logokejati.png" alt="AdminLTE Logo" class="brand-image img-circle elevation-3"
           style="opacity: .8">
      <span class="brand-text font-weight-light">KEJATI KAL-SEL</span>
    </a>
        ...
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item has-treeview">
            ...
            <ul class="nav nav-treeview">              
              ...
              <li class="nav-item">
                <a href="index.php?page=jabatan" class="nav-link">
              ...
              <li class="nav-item">
                <a href="index.php?page=alkes" class="nav-link">
                  <i class="nav-icon fa fa-list"></i>
...
<?php
$query ="select max(id_permintaan) as maxid from permintaan";
$hasil = mysqli_query($koneksi, $query);
$data = mysqli_fetch_array($hasil);
$id_permintaan = $data['maxid'];
$nourut = (int) substr($id_permintaan, 3, 3);
$nourut++;
$char = "PO";
              ...
              <form role="form" method="POST">
                <div class="card-body">
                  <div class="form-group">
                    <label for="exampleInputEmail1">Pilih Obat</label>
                    <select class="form-control" name="kd_obat" id="kd_obat" onchange="isi_otomatis()" />
                            <?php

                            echo "<option value=''>-- Pilih Obat --</option>";
                            $sql = $koneksi->query("select * from obat order by kd_obat");
                            while ($data = $sql->fetch_assoc()) {
                                echo "<option value ='$data[kd_obat]'>$data[nama_obat]</option>";
                            }
            ...
            <div class="card card-primary">
              ...
              <div class="card-body">
                  ...
                  <div class="form-group">
                    ...
                    <input type="text" class="form-control" name="id_permintaan" value="<?php echo $newId; ?>" readonly >
                  </div>
                  <div class="form-group">
...
if (isset($_POST['simpan'])) {
  ...
  $nama_peminta           = $_POST['nama_peminta'];
    ...
    $sql = $koneksi->query("INSERT INTO permintaan (id_permintaan,kd_obat,jumlah_permintaan,nama_peminta,status,tgl)VALUES('$id_permintaan','$kd_obat','$jumlah_permintaan','$nama_peminta','Belum di Konfirmasi',CURDATE())");
  $koneksi->query("UPDATE obat SET stok=stok-$jumlah_permintaan WHERE kd_obat='$kd_obat'");
        ...
        if ($sql ) {
            ...
            <script type="text/javascript">
                ...
                window.location.href = "permintaan_obat.php";
