...
<hr>
   <h3><center><b>LAPORAN PERMINTAAN OBAT DIKONFIRMASI  </b></center></h3>
<table class="table table-borderless" style="width: 100%"> 
	<tr>
...
<table border="1" width="100%" style="border-collapse: collapse;">
   ...
   <th width="25px" height="50px">Status</th>
    ...
    <tbody>
        ...
        $sql = $koneksi ->query("SELECT * from  permintaan INNER JOIN obat ON permintaan.kd_obat=obat.kd_obat WHERE status='Dikonfirmasi' ");
