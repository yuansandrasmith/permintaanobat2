...
<hr>
   <h3><center><b>LAPORAN PERMINTAAN OBAT PADA BULAN <?php echo  bulan_indo((int)$bulan1); ?>  </b></center></h3>
<table class="table table-borderless" style="width: 100%"> 
  <tr>
...
<table border="1" width="100%" style="border-collapse: collapse;">
   ...
   <th width="25px" height="50px">Status</th>
    ...
    <tbody>
        ...
        $sql = $koneksi ->query("SELECT * from  permintaan INNER JOIN obat ON permintaan.kd_obat=obat.kd_obat WHERE status='Dikonfirmasi' AND MONTH(tgl)='$bulan1' ");
        while ($data=$sql->fetch_assoc()) {

        ?>
          <tr>
              <td width="25px" height="50px"><center><?php echo $no++;?></center></td> 
              <td width="100px" height="50px"><center><?php echo $data['id_permintaan'];?></center></td>
