...
<hr>
   <h3><center><b>LAPORAN PERMINTAAN ALKES DIKONFIRMASI  </b></center></h3>
<table class="table table-borderless" style="width: 100%"> 
  <tr>
...
<table border="1" width="100%" style="border-collapse: collapse;">
   ...
   <th width="25px" height="50px">Status</th>
    ...
    <tbody>
        ...
        $sql = $koneksi ->query("SELECT * from  permintaan_alkes INNER JOIN alkes ON permintaan_alkes.kd_alkes=alkes.kd_alkes WHERE status='Dikonfirmasi' ");
