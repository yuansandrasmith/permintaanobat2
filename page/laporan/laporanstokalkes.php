...
<hr>
   <h3><center><b>LAPORAN STOK ALAT KESEHATAN   </b></center></h3>
<table class="table table-borderless" style="width: 100%"> 
	<tr>
...
<table border="1" width="100%" style="border-collapse: collapse;">
   ...
   <th width="25px" height="50px">Kode Alat Kesehatan</th>
   <th width="25px" height="50px">Nama Alat Kesehatan</th>
    ...
    <tbody>
        ...
        ?>
          <tr>
              ...
              <td width="100px" height="50px"><center><?php echo $data['kd_alkes'];?></center></td>
