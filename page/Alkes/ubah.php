<?php
    $kode = $_GET['kd_alkes'];
    $sql = $koneksi->query("SELECT * FROM alkes WHERE kd_alkes='$kode'");
        ...
        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
            <div class="card card-primary">
              <div class="card-header">
                <h3 class="card-title">Tambah Stok Alat Kesehatan</h3>
              </div>
              <!-- /.card-header -->
              <!-- form start -->
...
if (isset($_POST['simpan'])) {
  ...
  $sql = $koneksi->query("UPDATE alkes SET stok=(stok+$stok) WHERE kd_alkes='$kode'");
